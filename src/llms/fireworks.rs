...
impl LLM for Fireworks {
    ...
    fn get_model_name(&self) -> String {
        match &self.model {
            ...
            FireworksModel::Llama3_70b => "llama3-70b".to_string(),
            FireworksModel::Mixtral_8x7b => "mixtral-8x7b".to_string(),
            FireworksModel::Mistral_7b => "mistral-7b".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match &self.model {
            ...
            FireworksModel::Llama3_70b => "Fireworks-Llama3-70B".to_string(),
            FireworksModel::Mixtral_8x7b => "Fireworks-Mixtral-8x7B".to_string(),
            FireworksModel::Mistral_7b => "Fireworks-Mistral-7B".to_string(),
