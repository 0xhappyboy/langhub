...
impl LLM for Groq {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            GroqModel::Llama3_70b => "llama3-70b".to_string(),
            GroqModel::Mixtral_8x7b => "mixtral-8x7b".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match self.model {
            ...
            GroqModel::Llama3_70b => "Groq-Llama3-70B".to_string(),
            GroqModel::Mixtral_8x7b => "Groq-Mixtral-8x7B".to_string(),
