...
impl LLM for Together {
    ...
    fn get_model_name(&self) -> String {
        match &self.model {
            TogetherModel::Llama3_8b => "llama3-8b".to_string(),
            TogetherModel::Llama3_70b => "llama3-70b".to_string(),
            TogetherModel::Llama2_70b => "llama2-70b".to_string(),
            TogetherModel::Mixtral_8x7b => "mixtral-8x7b".to_string(),
            TogetherModel::Mistral_7b => "mistral-7b".to_string(),
            TogetherModel::Gemma_7b => "gemma-7b".to_string(),
            TogetherModel::Custom(name) => name.to_string(),
        }
    }

    fn get_provider_name(&self) -> String {
        match &self.model {
            TogetherModel::Llama3_8b => "Together-Llama3-8B".to_string(),
            TogetherModel::Llama3_70b => "Together-Llama3-70B".to_string(),
            TogetherModel::Llama2_70b => "Together-Llama2-70B".to_string(),
            TogetherModel::Mixtral_8x7b => "Together-Mixtral-8x7B".to_string(),
            TogetherModel::Mistral_7b => "Together-Mistral-7B".to_string(),
            TogetherModel::Gemma_7b => "Together-Gemma-7B".to_string(),
