...
impl LLM for OpenAI {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            OpenAIModel::Gpt4Vision => "gpt-4-vision-preview".to_string(),
            OpenAIModel::Gpt432k => "gpt-4-32k".to_string(),
            OpenAIModel::Gpt35Turbo => "gpt-3.5-turbo".to_string(),
            OpenAIModel::Gpt35Turbo16k => "gpt-3.5-turbo-16k".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match self.model {
            ...
            OpenAIModel::Gpt4Turbo => "OpenAI-GPT4-Turbo".to_string(),
            OpenAIModel::Gpt4Vision => "OpenAI-GPT4-Vision".to_string(),
            OpenAIModel::Gpt432k => "OpenAI-GPT4-32K".to_string(),
            OpenAIModel::Gpt35Turbo => "OpenAI-GPT3.5-Turbo".to_string(),
            OpenAIModel::Gpt35Turbo16k => "OpenAI-GPT3.5-Turbo-16K".to_string(),
            OpenAIModel::O1Preview => "OpenAI-O1-Preview".to_string(),
