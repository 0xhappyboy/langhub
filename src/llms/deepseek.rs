...
impl LLM for DeepSeek {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            DeepSeekModel::Chat => "deepseek-chat".to_string(),
            DeepSeekModel::Coder => "deepseek-coder".to_string(),
            DeepSeekModel::Reasoner => "deepseek-reasoner".to_string(),
        }
    }

    fn get_provider_name(&self) -> String {
        match self.model {
            DeepSeekModel::Chat => "DeepSeek-V3".to_string(),
            DeepSeekModel::Coder => "DeepSeek-Coder".to_string(),
