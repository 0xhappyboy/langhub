...
impl LLM for AlibabaTongyi {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            AlibabaModel::QwenPlus => "qwen-plus".to_string(),
            AlibabaModel::QwenMax => "qwen-max".to_string(),
            AlibabaModel::QwenMaxLong => "qwen-max-longcontext".to_string(),
            AlibabaModel::Qwen72B => "qwen-72b".to_string(),
            AlibabaModel::Qwen14B => "qwen-14b".to_string(),
            AlibabaModel::Qwen7B => "qwen-7b".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match self.model {
            ...
            AlibabaModel::QwenPlus => "Alibaba-Qwen-Plus".to_string(),
            AlibabaModel::QwenMax => "Alibaba-Qwen-Max".to_string(),
            AlibabaModel::QwenMaxLong => "Alibaba-Qwen-Max-Long".to_string(),
            AlibabaModel::Qwen72B => "Alibaba-Qwen-72B".to_string(),
            AlibabaModel::Qwen14B => "Alibaba-Qwen-14B".to_string(),
            AlibabaModel::Qwen7B => "Alibaba-Qwen-7B".to_string(),
