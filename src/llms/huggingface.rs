...
impl LLM for HuggingFace {
    ...
    fn get_model_name(&self) -> String {
        match &self.model {
            ...
            HuggingFaceModel::Llama2_13b => "llama2-13b".to_string(),
            HuggingFaceModel::Llama2_70b => "llama2-70b".to_string(),
            HuggingFaceModel::Llama3_8b => "llama3-8b".to_string(),
            HuggingFaceModel::Llama3_70b => "llama3-70b".to_string(),
            HuggingFaceModel::Mistral7b => "mistral-7b".to_string(),
            HuggingFaceModel::Mixtral8x7b => "mixtral-8x7b".to_string(),
            HuggingFaceModel::Falcon7b => "falcon-7b".to_string(),
            HuggingFaceModel::Falcon40b => "falcon-40b".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match &self.model {
            ...
            HuggingFaceModel::Llama2_13b => "HuggingFace-Llama2-13B".to_string(),
            HuggingFaceModel::Llama2_70b => "HuggingFace-Llama2-70B".to_string(),
            HuggingFaceModel::Llama3_8b => "HuggingFace-Llama3-8B".to_string(),
            HuggingFaceModel::Llama3_70b => "HuggingFace-Llama3-70B".to_string(),
            HuggingFaceModel::Mistral7b => "HuggingFace-Mistral-7B".to_string(),
            HuggingFaceModel::Mixtral8x7b => "HuggingFace-Mixtral-8x7B".to_string(),
            HuggingFaceModel::Falcon7b => "HuggingFace-Falcon-7B".to_string(),
            HuggingFaceModel::Falcon40b => "HuggingFace-Falcon-40B".to_string(),
