...
impl LLM for Replicate {
    ...
    fn get_model_name(&self) -> String {
        match &self.model {
            ReplicateModel::Llama3_8b => "llama3-8b".to_string(),
            ReplicateModel::Llama3_70b => "llama3-70b".to_string(),
            ReplicateModel::Mixtral_8x7b => "mixtral-8x7b".to_string(),
            ReplicateModel::Mistral_7b => "mistral-7b".to_string(),
            ReplicateModel::Custom(name) => name.to_string(),
        }
    }

    fn get_provider_name(&self) -> String {
        match &self.model {
            ReplicateModel::Llama3_8b => "Replicate-Llama3-8B".to_string(),
            ReplicateModel::Llama3_70b => "Replicate-Llama3-70B".to_string(),
            ReplicateModel::Mixtral_8x7b => "Replicate-Mixtral-8x7B".to_string(),
            ReplicateModel::Mistral_7b => "Replicate-Mistral-7B".to_string(),
