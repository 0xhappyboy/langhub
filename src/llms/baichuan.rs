...
impl LLM for Baichuan {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            BaichuanModel::Baichuan4 => "baichuan-4".to_string(),
            BaichuanModel::Baichuan3Turbo => "baichuan-3-turbo".to_string(),
            BaichuanModel::Baichuan3 => "baichuan-3".to_string(),
            BaichuanModel::Baichuan2Turbo => "baichuan-2-turbo".to_string(),
