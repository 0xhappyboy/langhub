...
impl LLM for Perplexity {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            PerplexityModel::SonarMedium => "sonar-medium".to_string(),
            PerplexityModel::SonarLarge => "sonar-large".to_string(),
            PerplexityModel::Llama3_8b => "llama3-8b".to_string(),
            PerplexityModel::Llama3_70b => "llama3-70b".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match self.model {
            ...
            PerplexityModel::SonarMedium => "Perplexity-Sonar-Medium".to_string(),
            PerplexityModel::SonarLarge => "Perplexity-Sonar-Large".to_string(),
            PerplexityModel::Llama3_8b => "Perplexity-Llama3-8B".to_string(),
            PerplexityModel::Llama3_70b => "Perplexity-Llama3-70B".to_string(),
