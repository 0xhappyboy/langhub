...
impl LLM for MiniMax {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            MiniMaxModel::Abab6_5S => "abab6.5s".to_string(),
            MiniMaxModel::Abab5_5 => "abab5.5".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match self.model {
            ...
            MiniMaxModel::Abab6_5S => "MiniMax-Abab6.5s".to_string(),
            MiniMaxModel::Abab5_5 => "MiniMax-Abab5.5".to_string(),
