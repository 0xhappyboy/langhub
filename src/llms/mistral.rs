...
impl LLM for Mistral {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            MistralModel::MistralTiny => "mistral-tiny".to_string(),
            MistralModel::MistralSmall => "mistral-small".to_string(),
            MistralModel::MistralMedium => "mistral-medium".to_string(),
            MistralModel::MistralLarge => "mistral-large".to_string(),
            MistralModel::Codestral => "codestral".to_string(),
            MistralModel::Embed => "mistral-embed".to_string(),
        }
    }
