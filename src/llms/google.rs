...
impl LLM for GoogleAI {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            GoogleModel::Gemini15ProVision => "gemini-1.5-pro-vision".to_string(),
            GoogleModel::GeminiPro => "gemini-pro".to_string(),
            GoogleModel::GeminiProVision => "gemini-pro-vision".to_string(),
            GoogleModel::GeminiUltra => "gemini-ultra".to_string(),
        }
    }

    fn get_provider_name(&self) -> String {
        match self.model {
            GoogleModel::Gemini15Pro => "Google-Gemini1.5-Pro".to_string(),
            GoogleModel::Gemini15Flash => "Google-Gemini1.5-Flash".to_string(),
            GoogleModel::Gemini15ProVision => "Google-Gemini1.5-Pro-Vision".to_string(),
            GoogleModel::GeminiPro => "Google-Gemini-Pro".to_string(),
            GoogleModel::GeminiProVision => "Google-Gemini-Pro-Vision".to_string(),
