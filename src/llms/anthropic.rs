...
impl LLM for Anthropic {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ...
            AnthropicModel::Claude3Sonnet => "claude-3-sonnet".to_string(),
            AnthropicModel::Claude3Haiku => "claude-3-haiku".to_string(),
            AnthropicModel::Claude21 => "claude-2.1".to_string(),
    ...
    fn get_provider_name(&self) -> String {
        match self.model {
            ...
            AnthropicModel::Claude3Sonnet => "Anthropic-Claude3-Sonnet".to_string(),
            AnthropicModel::Claude3Haiku => "Anthropic-Claude3-Haiku".to_string(),
            AnthropicModel::Claude21 => "Anthropic-Claude2.1".to_string(),
