...
impl LLM for ZhipuAI {
    ...
    fn get_model_name(&self) -> String {
        match self.model {
            ZhipuModel::GLM4 => "glm-4".to_string(),
            ZhipuModel::GLM4Air => "glm-4-air".to_string(),
            ZhipuModel::GLM4Flash => "glm-4-flash".to_string(),
            ZhipuModel::GLM3Turbo => "glm-3-turbo".to_string(),
            ZhipuModel::GLM4V => "glm-4v".to_string(),
        }
    }

    fn get_provider_name(&self) -> String {
        match self.model {
            ZhipuModel::GLM4 => "Zhipu-GLM-4".to_string(),
            ZhipuModel::GLM4Air => "Zhipu-GLM-4-Air".to_string(),
            ZhipuModel::GLM4Flash => "Zhipu-GLM-4-Flash".to_string(),
            ZhipuModel::GLM3Turbo => "Zhipu-GLM-3-Turbo".to_string(),
            ZhipuModel::GLM4V => "Zhipu-GLM-4V".to_string(),
        }
    }
